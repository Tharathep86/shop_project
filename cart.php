...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    header('Location: /thara74/shop_project/cart.php');
    exit;
}
require_login();
...
<form method="post" action="/thara74/shop_project/checkout.php" class="text-right mt-4"><button class="px-4 py-2 bg-red-700 text-white rounded">ไปชำระเงิน</button></form>
</div>
